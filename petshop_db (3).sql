...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19/05/2025 às 14:17
...
INSERT INTO `agendamentos` (`id_agendamento`, `id_cliente`, `id_pet`, `id_servico`, `data_hora`, `status`, `nome_pet`, `nome_dono`, `telefone`, `servico`) VALUES
(1, NULL, NULL, NULL, '2025-04-15 10:00:00', 'pendente', 'Pipoca', 'matheus', '81998876554', 'Banho');
...
INSERT INTO `clientes` (`id_cliente`, `nome`, `email`, `senha`, `telefone`, `endereco`, `data_cadastro`) VALUES
(1, 'matheus ferreira da silva ', 'matheusgnr531@gmail.com', '$2y$10$YNsMxu81v0jq2NoLG2HTH.E6NxauTfTXcRu/aAJ.mzro3NgP18XHG', '81998876554', 'rua da soledade n°55', '2025-05-13 14:35:16');
...
ALTER TABLE `agendamentos`
  ...
  ADD CONSTRAINT `agendamentos_ibfk_2` FOREIGN KEY (`id_pet`) REFERENCES `pets` (`id_pet`),
