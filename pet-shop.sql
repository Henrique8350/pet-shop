...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30/05/2025 às 15:52
...
CREATE TABLE `clientes` (
  ...
  `descricao_alergia` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `clientes` (`id_cliente`, `nome`, `email`, `senha`, `telefone`, `endereco`, `data_cadastro`, `data_nascimento`, `cpf`, `genero`, `tipo_sanguineo`, `alergia`, `descricao_alergia`) VALUES
(1, 'matheus ferreira da silva ', 'matheusgnr531@gmail.com', '$2y$10$YNsMxu81v0jq2NoLG2HTH.E6NxauTfTXcRu/aAJ.mzro3NgP18XHG', '81998876554', 'rua da soledade n°55', '2025-05-13 14:35:16', NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'asafe emanuel', 'rikudousenin743@gmail.com', '$2y$10$joeFXGtIKfWfzr62km0Huejd44c8kQtuJsIBdRSX2NyRpaIvSap0a', '81987654321', 'av.matheus botelho', '2025-05-20 13:05:51', NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'Paulo José dos Santos', 'paulosantos123@gmail.com', '$2y$10$i5CdOoSiEZpsz0ZXpwqPKu2GMX9JR0ksxVXzUcUoSh1NsBFS3Ar7i', '987786556', 'Rua Gomes taborda', '2025-05-27 14:44:51', NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'asafe', 'naruto123@gmail.com', '$2y$10$SwlGVpkBZhECpnzIWeBmkO2tRPG0fQx3PZPi5m382iVjqeKX0g89C', '(81) 91221-3443', 'Rua Konohagakure N°7', '2025-05-30 13:22:41', NULL, '12345678910', 'Masculino', 'A+', 'Não', '');
